...
def main(args):
    ...
    if args.one_network == True:
        ...
        from IterativePredict import predict
...
# args.huelabel,args.rowlabel,args.binRows
    ...
    parser.add_argument('--CNNbatch_sizeHR', dest='CNNbatch_sizeHR', default=1 ,type=int,
    ...
    parser.add_argument('--wsi_ext', dest='wsi_ext', default='.svs,.scn,.ndpi,.tif' ,type=str,
